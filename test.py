...
if __name__ == "__main__":
   einstein = ndimage.imread("./images/cat.png", flatten=True)
   marilyn = ndimage.imread("./images/people.png", flatten=True)
   x = einstein.shape[0]
   y = einstein.shape[1]
   marilyn = cv.resize(marilyn, (y, x), interpolation=cv.INTER_CUBIC)
